...
INPUT_BUCKET_NAME = "aws-training-ruan-lab2-input"

# TODO 2: Set output bucket name (must be globally unique)
OUTPUT_BUCKET_NAME = "aws-training-ruan-lab2-output"
...
class DataTransformer:
    ...
    def generate_presigned_url(self, bucketname, key):
        ...
        return s3.meta.client.generate_presigned_url('get_object', Params={'Bucket': bucketname, 'Key': key},ExpiresIn=900)
    ...
    def upload_file_to_bucket_enhanced(self, filename, bucket, key):
        ...
        bucket.upload_file(filename, key, ExtraArgs={'ServerSideEncryption': 'AES256', 'Metadata': {'contact' : 'gato@icomp.ufam.edu.br'}})
