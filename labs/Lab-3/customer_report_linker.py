...
def update_item_with_link(dynamodb, customer_id, report_url, table_name):
    ...
    dynamodb.Table(table_name).update_item(Key={'CustomerId': str(customer_id)}, UpdateExpression='SET CustomerReportUrl = :val1', ExpressionAttributeValues={':val1': report_url})
